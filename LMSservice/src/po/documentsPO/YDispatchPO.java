...
public class YDispatchPO extends DocumentPO implements Serializable {
	...
	public YDispatchPO(String date, String code, String doName, String account,String name2) {
		super();
		this.date = date;
		this.code = code;
		this.doName = doName;
